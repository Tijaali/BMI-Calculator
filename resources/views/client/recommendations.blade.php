                                        ...
                                        <div class="custom-block bg-white shadow-lg">
                                            <a href="#" class="text-decoration-none">
                                                ...
                                                <img src="{{asset('assets/images/over_break.jpg')}}"
                                                    class="custom-block-image img-fluid" alt="" style="height: 300px">
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <a href="#" class="text-decoration-none">
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">Start with brisk walking for 30 minutes most days of the week. Gradually increase intensity and duration as fitness improves.</p>
                                                </div>
                                        ...
                                        <a href="#" class="text-decoration-none">
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">Low-impact and great for full-body workout. Aim for 30 minutes of swimming laps or water aerobics sessions.</p>
                                                </div>
                                        ...
                                        <a href="#" class="text-decoration-none">
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">Either outdoors or on a stationary bike. Begin with shorter rides and gradually increase duration and intensity.</p>
                                                </div>
                                        ...
                                        <a href="#" class="text-decoration-none">
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">Stand with feet shoulder-width apart, lower your body as if sitting back into a chair, then rise back up. Works leg muscles.</p>
                                                </div>
                                        ...
                                        <a href="#" class="text-decoration-none">
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">Start in a plank position, lower your body until your chest nearly touches the floor, then push back up. Builds chest, shoulder, and arm strength.</p>
                                                </div>
                                        ...
                                        <a href="#" class="text-decoration-none">
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">With a dumbbell in each hand, bend forward at the waist with knees slightly bent. Pull the weights up to your sides, squeezing your shoulder blades together. Strengthens back muscles.</p>
                                                </div>
                                        ...
                                        <a href="#" class="text-decoration-none">
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">Step forward with one leg, lowering your hips until both knees are bent at 90 degrees, then return to standing. Targets leg muscles.</p>
                                                </div>
                                        ...
                                        <a href="#" class="text-decoration-none">
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">Aim for 150 mins/week (e.g., brisk walking, cycling).</p>
                                                </div>
                                        ...
                                        <a href="#" class="text-decoration-none">
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">Work major muscle groups 2x/week (e.g., squats, push-ups).</p>
                                                </div>
                                        ...
                                        <a href="#" class="text-decoration-none">
                                            <div class="d-flex">
                                                <div>
                                                    ...
                                                    <p class="mb-0">Regular stretching to improve range of motion.</p>
                                                </div>
